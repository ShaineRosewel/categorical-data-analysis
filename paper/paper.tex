...
This study uses the Global Survey of Working Arrangements (G-SWA, 2022) dataset. The G-SWA is a survey of individual workers across more than two dozen countries done occasionally. It collects data on outcomes, plans, desires and perceptions related to WfH along with the respondents' demographics, earnings, commute times, and more (Cevat Giray Aksoy \& Zarate (\citeproc{ref-datasource-2022}{2022})). We focus on Australia alone and use the wave 2 phase of data collection. The total sample size is 881. The variables used in the analysis are defined as follows:

\subsubsection{\texorpdfstring{Target variable: \texttt{decision}}{Target variable: decision}}\label{target-variable-decision}

\texttt{decision} is a binary variable. This is derived from \texttt{return\_office} which pertains to the response if employer announces that employees must return to the worksite 5+ days per week. \texttt{return\_office} could be one of the three options: \texttt{Look\ for\ a\ job\ to\ WFH\ 1-2\ days}, \texttt{Comply\ and\ return\ to\ worksite}, \texttt{Quit\ job}. For this study, we collapse \texttt{Look\ for\ a\ job\ to\ WFH\ 1-2\ days} and \texttt{Quit\ job} to obtain the \texttt{decision} variable which is 1 if response is \texttt{Comply\ and\ return\ to\ worksite} and 0 otherwise.
...
\begin{tabular}{lrrr}
\toprule
regionname & 0 & 1 & total\\
\midrule
 & 2 & 1 & 3\\
Australian Capital Territory & 5 & 13 & 18\\
New South Wales & 94 & 216 & 310\\
Northern Territory & 1 & 6 & 7\\
Queensland & 35 & 115 & 150\\
South Australia & 13 & 61 & 74\\
Tasmania & 2 & 14 & 16\\
Victoria & 67 & 158 & 225\\
Western Australia & 17 & 61 & 78\\
\bottomrule
\end{tabular}
\end{table}
...
Female & 129 & 299 & 428\\
Male & 105 & 346 & 451\\
Other/Prefer not to say & 2 & NA & 2\\
\bottomrule
\end{tabular}
\end{table}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/unnamed-chunk-21-1.pdf}}
...
education & 0 & 1 & total\\
\midrule
Graduate & 121 & 272 & 393\\
Secondary & 34 & 146 & 180\\
Tertiary & 81 & 227 & 308\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lrrr}
\toprule
industry job & 0 & 1 & total\\
\midrule
Agriculture & 1 & 8 & 9\\
Arts \& Entertainment & 4 & 4 & 8\\
Construction & 11 & 49 & 60\\
Education & 18 & 65 & 83\\
Finance or Insurance & 28 & 51 & 79\\
Government & 16 & 40 & 56\\
Health Care \& Social Assistance & 25 & 69 & 94\\
Hospitality \& Food Services & 7 & 15 & 22\\
Information & 20 & 52 & 72\\
Manufacturing & 7 & 46 & 53\\
Mining & 7 & 8 & 15\\
Other & 20 & 49 & 69\\
Professional \& Business Services & 34 & 70 & 104\\
Real Estate & 5 & 9 & 14\\
Retail Trade & 9 & 54 & 63\\
Transportation or Warehousing & 11 & 31 & 42\\
Utilities & 4 & 5 & 9\\
Wholesale Trade & 9 & 20 & 29\\
\bottomrule
\end{tabular}
\end{table}
...
\texttt{daysemployee\_work\_home}

\begin{table}[H]
\centering
\begin{tabular}{rrrr}
\toprule
daysemployee work home & 0 & 1 & total\\
\midrule
0 & 15 & 248 & 263\\
1 & 22 & 55 & 77\\
2 & 45 & 125 & 170\\
...
\texttt{value\_WFH\_rawpercent25}

\begin{table}[H]
\centering
\begin{tabular}{rrrr}
\toprule
value WFH rawpercent25 & 0 & 1 & total\\
\midrule
-30 & 2 & 12 & 14\\
-20 & NA & 5 & 5\\
-13 & 2 & 5 & 7\\
...
\texttt{commuting\_time}

\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/unnamed-chunk-28-1.pdf}}

\texttt{WFHperceptions}

\begin{table}[H]
\centering
\begin{tabular}{rrrr}
\toprule
WFHperceptions & 1 & 0 & total\\
\midrule
-95 & 7 & NA & 7\\
-75 & 7 & NA & 7\\
-25 & 19 & 5 & 24\\
...
We want to consider a starting binary logistic regression model with all enumerated variables as main effects and interaction on the following variables: \texttt{gender} and \texttt{education}, \texttt{gender} and \texttt{industry\_job}, \texttt{with\_kids} and \texttt{gender}. We then implement stepwise regression and a series of likelihood ratio tests to come up with the final model. In the event of poor performance, we can
